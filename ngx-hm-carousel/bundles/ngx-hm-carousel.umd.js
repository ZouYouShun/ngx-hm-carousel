(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('rxjs/BehaviorSubject'), require('rxjs/observable/fromEvent'), require('rxjs/observable/interval'), require('rxjs/Subject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/forms', 'rxjs/BehaviorSubject', 'rxjs/observable/fromEvent', 'rxjs/observable/interval', 'rxjs/Subject'], factory) :
	(factory((global['ngx-hm-carousel'] = {}),global.ng.common,global.ng.core,global.ng.forms,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx));
}(this, (function (exports,common,core,forms,BehaviorSubject,fromEvent,interval,Subject) { 'use strict';
...
var bufferCount = bufferCount_1.bufferCount;
var debounceTime = debounceTime_1.debounceTime;
var merge = merge_3.merge;
var switchMap = switchMap_1.switchMap;
 ...
 * @return {?}
 */
function onlyOnBrowser(variableId) {
    return function (target, key, descriptor) {
        ...
        descriptor.value = function () {
            ...
            if (common.isPlatformBrowser(this[variableId])) {
...
var NgxHmCarouselComponent = /** @class */ (function () {
    ...
    function NgxHmCarouselComponent(platformId, _renderer) {
        ...
        this.restart = new BehaviorSubject.BehaviorSubject(null);
        this.stopEvent = new Subject.Subject();
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.onResize = function (event) {
        this.setViewWidth();
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.ngAfterContentInit = function () {
        this.initVariable();
    };
    /**
     * @return {?}
    ...
    NgxHmCarouselComponent.prototype.initVariable = function () {
        ...
        var /** @type {?} */ startEvent = this.restart.asObservable(); // .merge(this.mourseLeave); // .map(() => console.log('start'))
        var /** @type {?} */ stopEvent = this.stopEvent.asObservable();
        if (this.mourseEnable) {
            var /** @type {?} */ mourseOver = fromEvent.fromEvent(this.containerElm, 'mouseover').pipe(tap(function () { return _this.isInContainer = true; }));
            var /** @type {?} */ mourseLeave = fromEvent.fromEvent(this.containerElm, 'mouseleave').pipe(tap(function () { return _this.isInContainer = true; }));
            startEvent = startEvent.pipe(merge(mourseLeave));
            stopEvent = stopEvent.pipe(merge(mourseOver));
        }
        // const debounceTime = this.delay < this.speed ? this.delay : this.delay - this.speed;
        this.doNext = startEvent.pipe(debounceTime(this.delay), switchMap(function () { return _this.runProgress(20).pipe(tap(function () {
            // console.log('next');
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.callClick = function (positionX) {
        var /** @type {?} */ toIndex = this.currentIndex + Math.floor(positionX / this.elmWidth);
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.drawView = function (index) {
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.playCycle = function (index) {
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.handlePan = function (e) {
        ...
        switch (e.type) {
            ...
            case 'panend':
                ...
                if (Math.abs(e.deltaX) > this.elmWidth * PANBOUNDARY) {
                    var /** @type {?} */ moveNum = this.isDragMany ?
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.setIndex = function (index) {
        if (this.autoplay) {
            this.stopEvent.next();
    ...
    NgxHmCarouselComponent.prototype.runProgress = function (betweenTime) {
        ...
        return interval.interval(betweenTime).pipe(tap(function (t) {
     ...
     * @return {?}
     */
    NgxHmCarouselComponent.prototype.getWindowWidthToNum = function () {
        var /** @type {?} */ initNum = 3;
        // 610
...
], NgxHmCarouselComponent.prototype, "ngAfterContentInit", null);
__decorate([
    onlyOnBrowser('platformId'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], NgxHmCarouselComponent.prototype, "ngAfterViewInit", null);
__decorate([
    onlyOnBrowser('platformId'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], NgxHmCarouselComponent.prototype, "ngOnDestroy", null);
 ...
 * @nocollapse
 */
NgxHmCarouselModule.ctorParameters = function () { return []; };
