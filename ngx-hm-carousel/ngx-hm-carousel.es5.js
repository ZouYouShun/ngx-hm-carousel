...
import { Component, ContentChild, ContentChildren, Directive, EventEmitter, HostListener, Inject, Input, NgModule, Output, PLATFORM_ID, Renderer2, ViewChild, ViewEncapsulation } from '@angular/core';
...
var NgxHmCarouselComponent = /** @class */ (function () {
    ...
    function NgxHmCarouselComponent(platformId, _renderer) {
        ...
        this.restart = new BehaviorSubject$1(null);
        this.stopEvent = new Subject$1();
    ...
    NgxHmCarouselComponent.prototype.initVariable = function () {
        ...
        if (this.mourseEnable) {
            var /** @type {?} */ mourseOver = fromEvent$1(this.containerElm, 'mouseover').pipe(tap(function () { return _this.isInContainer = true; }));
            var /** @type {?} */ mourseLeave = fromEvent$1(this.containerElm, 'mouseleave').pipe(tap(function () { return _this.isInContainer = true; }));
    ...
    NgxHmCarouselComponent.prototype.runProgress = function (betweenTime) {
        ...
        return interval$1(betweenTime).pipe(tap(function (t) {
 ...
 */
export { NgxHmCarouselModule, NgxHmCarouselItemDirective, NgxHmCarouselComponent, onlyOnBrowser as ɵa };
//# sourceMappingURL=ngx-hm-carousel.es5.js.map
