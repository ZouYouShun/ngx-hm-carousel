...
class NgxHmCarouselComponent {
    ...
    initVariable() {
        ...
        if (this.mourseEnable) {
            const /** @type {?} */ mourseOver = fromEvent$1(this.containerElm, 'mouseover').pipe(tap(() => this.isInContainer = true));
            const /** @type {?} */ mourseLeave = fromEvent$1(this.containerElm, 'mouseleave').pipe(tap(() => this.isInContainer = true));
    ...
    runProgress(betweenTime) {
        ...
        return interval$1(betweenTime).pipe(tap(t => {
